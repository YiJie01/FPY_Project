...
return [
    ...
    */
    'columns'                       => [
        'alpha'   => [
            'rows'  => ['description', 'email', 'name', 'slug','productname','publisher','status','type'],
            'class' => 'fa fa-sort-alpha',
        ],
        
        'amount'  => [
            'rows'  => ['amount', 'price','productprice','date'],
            'class' => 'fa fa-sort-amount',
        ],
        'numeric' => [
            'rows'  => ['created_at', 'updated_at', 'level', 'id', 'phone_number','productid'],
